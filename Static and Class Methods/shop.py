...
# •	add_item(item_name: str) - adds 1 to the quantity of the given item. On success, the method should return "{item_name} added to the shop".
...
# it should return "{amount} {item_name} removed from the shop". Otherwise, the method should return "Cannot remove {amount} {item_name}"
...
class Shop:
    def __init__(self, name: str, type: str, capacity: int):
        ...
        self.items = {}  # empty dictionary at first that stores name: quantity
